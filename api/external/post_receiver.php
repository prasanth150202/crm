<?php
// post_receiver.php
// Receives generic POST requests, matches and stores data
...
// Sanitize lead output
$sanitized_lead = array_map(function($value) {
    return is_string($value) ? htmlspecialchars($value, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') : $value;
}, $lead);
echo json_encode(['success' => true, 'lead' => $sanitized_lead]);
