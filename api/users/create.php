...
try {
    // NEW: Check user limit before creating user
    ...
    $subscriptionMiddleware = getSubscriptionMiddleware($pdo, $planFeatureChecker, $currentUser['org_id']);
    ...
    if (!$userLimitCheck['allowed']) {
        ...
        echo json_encode([
            ...
            'current_count' => $userLimitCheck['current_count'],
            'limit' => $userLimitCheck['limit'],
            'price_per_additional_user' => $userLimitCheck['price_per_additional_user'] ?? null,
            'plan_name' => $userLimitCheck['plan_name'] ?? null
        ]);
        exit;
    }
